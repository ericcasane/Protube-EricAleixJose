...
export default function ProfilePage() {
  ...
  if (loading)
    return (
      <div className="flex justify-center p-10">{t("common.loading")}</div>
    );
  if (error || !profile)
    return (
      <div className="flex justify-center p-10 text-danger">
          ...
          <div className="rounded-full p-1 bg-background">
            <Image
              ...
              src={
                ...
                `https://ui-avatars.com/api/?name=${profile.name}+${profile.surname}&background=random`
              }
              width={160}
            />
          </div>
